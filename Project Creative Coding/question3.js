...
function preload() {
  ...
  roadImage = loadImage('Phantom_Patrol_Resources/wholeRoad.png');
  spiralImage = loadImage('Phantom_Patrol_Resources/Spiral.png');
  trapstartImage = loadImage('Phantom_Patrol_Resources/trap1.png');
  trapdoneImage = loadImage('Phantom_Patrol_Resources/trap4.png');
  ghostImage = loadImage('Phantom_Patrol_Resources/ghost.png');
  titleImage = loadImage('Phantom_Patrol_Resources/Title.png');

  //openingAni = loadImage('Phantom_Patrol_Resources/Opening.gif')
  file = loadJSON('leaderboard.json')

  //poof = loadSound('Phantom_Patrol_Resources/208111__planman__poof-of-smoke.wav')
  //sigh = loadSound('Phantom_Patrol_Resources/359153__horroraudio__ghostly-sigh.wav')
  //cannonshot = loadSound('Phantom_Patrol_Resources/517664__devern__8-bit-cannon.wav')

  carAni = loadAnimation('Phantom_Patrol_Resources/Mini_van_L_Off.png',
    'Phantom_Patrol_Resources/Mini_van_L_On.png')
  trapAni = loadAnimation('Phantom_Patrol_Resources/trap1.png', 'Phantom_Patrol_Resources/trap2.png',
    'Phantom_Patrol_Resources/trap3.png')
}
...
function setup() {
  ...
  cursor('Phantom_Patrol_Resources/Crosshairs.png', 16, 16);
